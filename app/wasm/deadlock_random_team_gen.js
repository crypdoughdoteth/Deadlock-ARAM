...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./deadlock_random_team_gen_bg.js": import0,
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('deadlock_random_team_gen_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
...
__wbg_init({module_or_path: "/./wasm/deadlock_random_team_gen_bg.wasm"}).then((wasm) => {
